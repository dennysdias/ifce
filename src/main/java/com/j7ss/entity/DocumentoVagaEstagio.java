...
//## Getters Setters
	...
	public static DAO<DocumentoVagaEstagio> getDao() {
		return dao;
	}

	public static void setDao(DAO<DocumentoVagaEstagio> dao) {
		DocumentoVagaEstagio.dao = dao;
	}
	...
	public void setDocumentoAlunoMessages(
			List<DocumentoVagaEstagioMessage> documentoAlunoMessages) {
